...
function : Let Identifier Colon Identifier Assign '(' formalParameterList ')' '=>' ( singleExpression
                                                                                        | '{' statement '}') ;
...
singleExpression
    ...
    | Identifier ( '(' (singleExpression (',' singleExpression)*)? ')' )?                  # FunctionCall
    | ( DecimalLiteral | StringLiteral )                                     # Numeric
    | '(' singleExpression ')'                                               # GroupExpression
    ;
